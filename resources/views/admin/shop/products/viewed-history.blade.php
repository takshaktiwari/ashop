<x-admin.layout>
    <x-admin.breadcrumb title='Products' :links="[['text' => 'Dashboard', 'url' => route('admin.dashboard')], ['text' => 'Products', 'url' => route('admin.shop.products.index')], ['text' => 'Viewed History']]" :actions="[
                ...
                <form action="">
                    <div class="row">
                        <div class="col-12 col-md-3">
                            <input type="text" name="search_text" class="form-control mb-sm-0 mb-2"
                                placeholder="Search eg. Name, SKU, Tags" value="{{ request('search_text') }}">
                        </div>
                        <div class="col-12 col-md-3">
