<x-ashop-ashop:user-account>
    <x-slot:breadcrumb>
        <x-breadcrumb title="Edit Address" :links="[['text' => 'Home', 'url' => url('/')], ['text' => 'Dashboard', 'url' => route('shop.user.dashboard')], ['text' => 'Address Book', 'url' => route('shop.user.addresses.index')], ['text' => 'Edit']]" />
    </x-slot:breadcrumb>
